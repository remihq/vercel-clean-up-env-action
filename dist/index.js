...
class VercelEnvVariabler {
    constructor(token, projectName, teamId, gitBranch) {
        this.token = token;
    ...
    cleanUpExistingEnvVariables() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (env) {
                (0, core_1.info)(`Found ${env.length} existing total env variables`);
                const needsCleanUpEnv = this.filterOutUnQualifiedEnvVariables(env, this.gitBranch);
                for (const existingEnvVariable of needsCleanUpEnv) {
                    try {
                        const deleteResponse = yield (0, vercel_1.deleteEnvVariable)(this.vercelClient, this.projectName, existingEnvVariable.id);
                        if (deleteResponse === null || deleteResponse === void 0 ? void 0 : deleteResponse.data) {
                            (0, core_1.info)(`${existingEnvVariable.key} for git branch: ${this.gitBranch} cleaned up successfully.`);
                        }
                        else {
                            (0, core_1.info)(`${JSON.stringify(deleteResponse)}`);
                        }
                    }
                    catch (err) {
                        // @ts-ignore
    ...
    filterOutUnQualifiedEnvVariables(variables, gitBranch) {
        return variables.filter((item) => item.target.includes("preview")).filter((item) => item.gitBranch && item.gitBranch === gitBranch);
    }
}
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const gitBranch = (0, core_1.getInput)("gitBranch", {
                required: true,
            });
            const teamId = (0, core_1.getInput)("teamId");
            const envVariabler = new VercelEnvVariabler_1.default(token, projectName, teamId, gitBranch);
            yield envVariabler.cleanUpExistingEnvVariables();
            (0, core_1.info)(`Vercel env variables cleaned up successfully for branch: ${gitBranch}`);
        }
        catch (error) {
            // @ts-ignore
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deleteEnvVariable = exports.patchEnvVariable = exports.postEnvVariable = exports.listEnvVariables = exports.VercelEnvVariableTarget = void 0;
...
const deleteEnvVariable = (vercelClient, projectName, envVariableId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield vercelClient.delete(`/projects/${projectName}/env/${envVariableId}`);
});
exports.deleteEnvVariable = deleteEnvVariable;
